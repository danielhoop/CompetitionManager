...
public class Score implements Comparable<Score>, ICRUD {
    ...
    // competitor
    public ch.ffhs.pa.competitionmanager.entities.Competitor getCompetitor() {
        return competitor;
    }
    public void setCompetitor(ch.ffhs.pa.competitionmanager.entities.Competitor competitor) {
        this.competitor = competitor;
    }
    // timeNeeded
