...
public class Connection implements Runnable {
     ...
     * of the field.
     *
     * @throws IOException if the connectionSocket is not present and the inputStream is inaccessible
     *
     */
    ...
    private void sendResponse() throws IOException {
        ...
        // that tells the client that the file was not found
            ...
            String http404Response = "HTTP/1.1 404 Not Found\r\n\r\n" + "<!DOCTYPE html>\n" +
                    ...
                    "\n" +
                    "<head>\n" +
                    "    <title>Ninja Warriors</title>\n" +
                    "</head>\n" +
                    "\n" +
                    "<body><h1>\n" +
                    "404 Fehler: Seite wurde nicht gefunden\n" +
                    "</h1></body>\n" +
                    "\n" +
                    "</html>";
